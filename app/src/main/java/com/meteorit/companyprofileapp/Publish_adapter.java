...
public class Publish_adapter extends RecyclerView.Adapter<Publish_adapter.Holder> {
    ...
    public Publish_adapter(ArrayList<Integer> id, ArrayList<String> gambar, ArrayList<String> judul, ArrayList<String> konten,
                           ArrayList<String> tanggal,ArrayList<String> file_pendukung,Context ct) {
        this.id = id;
        this.gambar = gambar;
        this.judul = judul;
        this.konten = konten;
        this.tanggal=tanggal;
        this.file_pendukung=file_pendukung;
        this.ct = ct;
    }
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.publish_adapter,parent,false);
        return new Holder(v);
    }
    ...
    public void onBindViewHolder(final Holder holder, final int position) {
        ...
        holder.readmore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(ct,Publishdetail_Activity.class);
                ...
                i.putExtra("file_pendukung",file_pendukung.get(position));
                ct.startActivity(i);
            }
        });
